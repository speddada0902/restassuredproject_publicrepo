...
public class GET_Code_Aplha2 {
	...
	public void getCountryName_InputValid2LetterCode_ReturnSuccessResponse() {
					...
					//Response Object
					Response response = httprequest.request(Method.GET,"us");
					...
					sf.assertEquals(actualCountryName,"United States of America");
